...
//    Amacim bu sinifi extend etmek ve icindeki hazir metodlari kullanmak
    ...
    public void setup(){
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));  // 20 sn bekle ama eger daha erken acilirsa bekleme (selenium'dan gelir)
                                                                            //Thread.sleep(20); : bu ise acilsa da sayfa 20 sn tamamlamali. bu yuzden hard'tir (java'dan gelir)
                                                                            //Explicit: local yani yerel bir beklme cesididr. implicitlyWait calismadigi durumlarda kullaniriz (selenium'dan gelir)
    }
    //tearDown
//    @After
...
//===============Explicit Wait==============//
    ...
    public static void tumSayfaImg () throws IOException {

        File resim = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        String currentDate = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
        String path = System.getProperty("user.dir") + "\\test-output/tumSayfaImg\\"+currentDate+"image.png";
...
//    Bu method ile sayfanin en altina inebiliriz
    ...
    // girmis oldugum metni js yoluyla elemte yazdirabiliriz
    // Bu method sendKeys methoduna bir alternatiftir. Bizim onceligimiz her zaman sendKeys'tir.
